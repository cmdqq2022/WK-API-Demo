<template>
  <div id="demo-list">
    ...
    <ul id="list" ref="list" @loadMore="onLoadMore" :preloadItemNumber="5" @scroll="onScroll"
      :numberOfRows="dataSource.length" :clipChildren="false" :initialContentOffset='600'>
      <!--
        li 有两个参数是一定要加上的。
      ...
      -->
      <li v-for="(ui, index) in dataSource" :key="index" :type="ui.style" @layout="onItemLayout" :focusable=false>
        <div class="li-item" :focusable=true :focusScale="1.05" :enableFocusBorder=true>
