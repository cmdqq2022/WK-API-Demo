<template>
  <div class="button-demo">
    <label>按钮和状态绑定:</label>
    <button :class="{ 'is-active': isClicked }" :focusable="true" requestFocus="true" class="button-demo-1"
      @click="clickView">
      <span v-if="isClicked" class="button-text">视图已经被点击了，再点一下恢复</span>
      <span v-else class="button-text">视图尚未点击</span>
    </button>
    <img v-show="isClicked" src="http://test-mp.hiliad.com/static/images/WX20201028-180320@2x.png"
