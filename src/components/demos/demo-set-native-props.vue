<template>
  <div class="set-native-props-demo">
    ...
    <div class="native-demo-1-drag" :style="{ width: this.screenWidth }" @touchstart="onTouchDown1"
      @touchmove="onTouchMove1">
      <div ref='demo-1-point' class="native-demo-1-point"></div>
    </div>
    <div class="splitter"></div>
    <label>普通渲染实现拖动效果</label>
    <div class="native-demo-2-drag" :style="{ width: this.screenWidth }" @touchstart="onTouchDown2"
